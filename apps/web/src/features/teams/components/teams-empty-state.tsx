...
export function TeamsEmptyState(): ReactElement {
  return (
    <Card className="flex min-h-96 items-center justify-center border-dashed">
      <div className="mx-auto grid max-w-sm justify-items-center gap-4 px-6 text-center">
        ...
        <div className="grid gap-2">
          <h2 className="text-h4">No teams yet</h2>
          <p className="text-sm text-muted-foreground">Create your first team to organize collaboration.</p>
        </div>
      </div>
    </Card>
  );
