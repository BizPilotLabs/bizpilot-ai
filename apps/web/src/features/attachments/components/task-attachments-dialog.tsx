  ...
  return (
    <>
          ...
          {attachmentsQuery.isSuccess && attachments.length > 0 ? (
            <div className="grid gap-3">
              ...
              <ul className="grid gap-2">
                {attachments.map((attachment) => <AttachmentRow key={attachment.id} attachment={attachment} canDelete={canDelete} onDelete={setAttachmentToDelete} onDownload={handleDownload} />)}
              </ul>
            </div>
          ) : null}
        </div>
      ...
      <ConfirmationDialog
        ...
        description="This attachment will be soft deleted and its stored file will be removed from object storage."
        confirmLabel="Delete attachment"
        error={deleteMutation.isError ? getAttachmentErrorMessage(deleteMutation.error) : null}
        errorTitle="Unable to delete attachment"
